resource "aws_instance" "VRG-EC2-1-public" {
  ...
  #   aws_security_group.n_virginia_allow_public_http_sg.id,
  # aws_security_group.n_virginia_allow_public_ssh_sg.id]

  tags = {
    Name = "${var.dev_env_type}-${var.n_virginia_region}-Public-Win"
  }
}
...
# resource "aws_security_group" "n_virginia_allow_public_ssh_sg" {
#     name        = "${var.dev_env_type}-${var.n_virginia_region}-${var.env_name}-allow_ssh_sg"
...
# resource "aws_security_group" "n_virginia_allow_public_http_sg" {
#     name        = "${var.dev_env_type}-${var.n_virginia_region}-${var.env_name}-allow_http_sg"
